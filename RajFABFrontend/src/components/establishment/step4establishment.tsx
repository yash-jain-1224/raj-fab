  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="flex gap-3 justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <Checkbox
              ...
              checked={formData.sameAsFactoryEmployer ?? false}
              onCheckedChange={(checked) => {
                const employer = checked
                  ...
                  updateFormData(`${sectionKey}`, employer);
                  updateFormData(`sameAsFactoryEmployer`, checked);

                updateFormData(`${sectionKey}.typeOfEmployer`, checked ? "owner" : "");
              }}
            />
            <Label htmlFor="sameAsFactoryEmployer" className="text-sm leading-snug cursor-pointer">
              <h3 className="font-semibold text-base">Same As Factory Employer</h3>
            </Label>
          </div>
        </div>
        ...
        {/* Designation */}
        <div className="space-y-2">
          <Label>2. Designation<span className="text-red-500">*</span></Label>
          <Input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateFormData(`${sectionKey}.relativeName`, e.target.value)
                }
                className={
