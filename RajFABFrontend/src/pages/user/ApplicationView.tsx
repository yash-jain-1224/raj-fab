...
export default function ApplicationView() {
  ...
  const applicationMap: Record<string, React.ReactNode> = {
    ...
    stpl_registration: <BoilerSteamPipelineDetails formId={applicationId} />,
    stpl_amendment: <BoilerSteamPipelineDetails formId={applicationId} />,
    stpl_renewal: <BoilerSteamPipelineDetails formId={applicationId} />,
    boiler_repairer: <BoilerRepairerDetails formId={applicationId} />,
    boiler_repairer_registration: <BoilerRepairerDetails formId={applicationId} />,
    boiler_repairer_renewal: <BoilerRepairerDetails formId={applicationId} />,
    economiser: <EconomiserView />,
    economiser_registration: <EconomiserView />,
    economiser_renewal: <EconomiserView />,
    welder: <WelderView />,
    welder_registration: <WelderView />,
    welder_renewal: <WelderView />,
