...
<Field label="State">
<Input value={boe.state} onChange={(e)=>updateBoe("state",e.target.value)}/>
</Field>

<Field label="BOE No">
<Input value={boe.boeNo} onChange={(e)=>updateBoe("boeNo",e.target.value)}/>
</Field>

<Field label="Date">
<Input type="date" value={boe.date} onChange={(e)=>updateBoe("date",e.target.value)}/>
</Field>
